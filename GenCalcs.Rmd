...
write_csv(gen_final,'/Users/marcdaalder/testing/intensity.csv', append=FALSE)

ggplot(data=gen_final, aes(x=TP_sort,y=intensity))+
  geom_point()

gen_mean = gen_final %>%
  aggregate(cbind(intensity, TP_sort) ~ TP, mean)

ggplot(data=gen_mean, aes(x=TP_sort,y=intensity))+
  geom_point()
