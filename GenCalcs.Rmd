...
gen_assigned = mutate(generation_trans,
                    factor=
                      ifelse(POC_Code=='HLY2201',
                        ...
                        ifelse((POC_Code=='HWA1101' & Fuel_Code=='Gas') | POC_Code=='HWA1102',.683,
                               ifelse(POC_Code=='JRD1101',.548,
                                      ifelse(POC_Code=='KAW0111' | POC_Code=='KAW0112' | POC_Code=='KAW2201',.06, #Topp2 is not yet running, it will be KAW2201 KAW0 or similar. Should be zero carbon. Keep an eye on this. Comment date: 24 Feb 26
                   ...
                   gen = ifelse(Tech_Code=='BAT',0,gen)) #removes batteries from gen (numerator and denominator)

#tidy up df
gen_tidied = select(gen_assigned,Trading_Date,'Trading Period',gen,real_factor)


#condense generation instances into single entries for each TP on each date
gen_final = gen_tidied %>% 
